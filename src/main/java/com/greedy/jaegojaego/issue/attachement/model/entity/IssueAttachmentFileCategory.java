...
@Entity(name = "issueAttachmentFileCategory")
@Table(name = "ATTACHMENT_FILE_CATEGORY")
public class IssueAttachmentFileCategory {
    ...
    public IssueAttachmentFileCategory() {
    }

    public IssueAttachmentFileCategory(int attachmentFileCategoryNo, String attachmentFileCategoryName) {
    ...
    public String toString() {
        return "IssueAttachementFileCategory{" +
